...
(40, 'Liam', 'Harris', 'liamh@live.com', '555-0123', '2828 Birch St', 'Richmond', 'VA', '23220','USA');
 ...
 Select * from Customers
   ...
   Напиши SQL-запрос, который выбирает из таблицы Products такие строки, 
   в которых в колонке ProductName встречается буква 'e', используя оператор LIKE.
...
ORDER BY SaleAmount DESC;
   ...
   22. Write a query to select the distinct Category, ProductName, and Price for products 
   that are priced above $50, using DISTINCT on three columns.
