...
use sqlhomework9
	...
	select Orders.OrderID, Customers.FirstName, Customers.LastName, Customers.Country, Orders.TotalAmount
	FROM Orders
	inner join Customers
	on Orders.CustomerID=Customers.CustomerID
	...
	select Payments.PaymentID, Payments.OrderID, Payments.Amount as PaidAmount, Orders.Quantity, Products.Price, (Orders.Quantity * Products.Price) AS ExpectedAmount
	from Payments
	inner join Orders
...
JOIN Employees Manager ON Employee.ManagerID = Manager.EmployeeID
